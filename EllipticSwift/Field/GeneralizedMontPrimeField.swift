...
public class GeneralizedMontPrimeField<T>: PrimeFieldProtocol where T: FiniteFieldCompatible, T: MontArithmeticsCompatible  {
...
//    }
    ...
    public func isEqualTo(_ other: GeneralizedMontPrimeField<T>) -> Bool {
    ...
    internal func toElement(_ a: T) -> GeneralizedPrimeFieldElement<GeneralizedMontPrimeField<T>> {
        return GeneralizedPrimeFieldElement<GeneralizedMontPrimeField<T>>(a, self)
    }
