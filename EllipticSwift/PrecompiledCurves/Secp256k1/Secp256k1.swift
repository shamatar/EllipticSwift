...
let secp256k1PrimeField = MontPrimeField<U256>(secp256k1PrimeBUI)
...
public let secp256k1Curve: WeierstrassCurve<MontPrimeField<U256>> = {
    let curve = WeierstrassCurve(field: secp256k1PrimeField, order: secp256k1CurveOrder, A: U256(0), B: U256(7))
