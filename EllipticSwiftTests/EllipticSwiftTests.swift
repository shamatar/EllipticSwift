...
class EllipticSwiftTests: XCTestCase {
    ...
    func testLargeFieldInv() {
        ...
        let secp256k1PrimeField = GeneralizedNaivePrimeField<U256>(secp256k1Prime)
        for i in 0 ..< 10 {
            let ar = BigUInt.randomInteger(lessThan: secp256k1PrimeBUI)
            let a = GeneralizedPrimeFieldElement.fromBytes(ar.serialize(), field: secp256k1PrimeField)
    ...
    func testLargeFieldMul() {
        ...
        for i in 0 ..< 10 {
            ...
            let a = GeneralizedPrimeFieldElement.fromBytes(ar.serialize(), field: secp256k1PrimeField)
            let b = GeneralizedPrimeFieldElement.fromBytes(br.serialize(), field: secp256k1PrimeField)
    ...
    func testLargeFieldPow() {
        ...
        for i in 0 ..< 10 {
            ...
            let a = GeneralizedPrimeFieldElement.fromBytes(base.serialize(), field: secp256k1PrimeField)
    ...
    func testFieldInversion() {
        ...
        let field = GeneralizedNaivePrimeField<U256>(modulus)
        let fe1 = GeneralizedPrimeFieldElement.fromValue(UInt64(3), field: field)
        let inv = fe1.inv()
    ...
    func testMontFieldConversion() {
        ...
        let forward = GeneralizedPrimeFieldElement.fromValue(UInt64(3), field: field)
...
//    }
    ...
    func testMontMultiplication() {
        let modulus = BigUInt(97)
        let field = GeneralizedMontPrimeField<U256>(modulus)
        let a = GeneralizedPrimeFieldElement.fromValue(UInt64(43), field: field)
        let b = GeneralizedPrimeFieldElement.fromValue(UInt64(56), field: field)
        let mul = a * b
        let value = mul.value
        XCTAssert(value == 80)
    }
    ...
    func testModularSquareRoot() {
        ...
        let bn256PrimeField = GeneralizedNaivePrimeField<U256>(bn256Prime)
        ...
        let xReduced = GeneralizedPrimeFieldElement.fromValue(x, field: primeField)
